...
namespace Nahhas.Shared.Helpers.Extensions.FormFile
{
    public static class FormFileExtensions
    {
        ...
        public static bool IsImage(this IFormFile postedFile)
        {
            ...
            //-------------------------------------------
            if (Path.GetExtension(postedFile.FileName).ToLower() != ".jpg" && Path.GetExtension(postedFile.FileName).ToLower() != ".png" && Path.GetExtension(postedFile.FileName).ToLower() != ".gif" && Path.GetExtension(postedFile.FileName).ToLower() != ".jpeg")
                return false;
